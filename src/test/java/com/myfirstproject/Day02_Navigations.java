...
//        Close/Quit the browser
        //There are two ways to close to browser: close() or quit(). We should NOT use BOTH
        //driver.close();
        driver.quit();

        /*
        *****What is the differences between get and navigate to functions?
        * Similarities: both let you go to a page
        * get is more common tha navigate to
        * get accepts ONL String as url, navigate to accepts both string and URL
        * navigate has more options such as to(), back(), forward(), refresh()

        ******What is the difference between close and quit?
        * close closed ONLY last active window
        * quit closed ALL ACTIVE windows
