...
//        }
    ...
    public void printAllRows(){
        ...
        driver.get("https://the-internet.herokuapp.com/tables");
        System.out.println("\n===Print all rows===\n");
        List<WebElement> allRows = driver.findElements(By.xpath("(//tbody)[1]//tr")); //tbody tag covers only table body. We will not get header part
        int rowNumber = 1;
        for (WebElement w : allRows){
...
//    printData(2,3); => prints data in 2nd row 3rd column
    ...
    public void getCallValueTest(){
        ...
        System.out.println(printCell(2,3));
