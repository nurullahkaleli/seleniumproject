...
//    When user clicks on the Start button
        ...
        //Thread.sleep(10000); // Hard wait is working. But it is not recommended. This is not dynamic. We need to use explicit wait.

        //Using Explicit Wait
        //1st: Create WebDriverWait object
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));

        //2nd:Using the wait object to handle the wait
...
//    Then verify the 'Hello World!' Shows up on the screen
    ...
    public void explicitWaitTest2(){
        ...
        //2nd:Using the wait object to handle the wait and locate the element
