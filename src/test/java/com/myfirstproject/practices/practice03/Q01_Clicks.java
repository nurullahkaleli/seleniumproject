...
//        Click all the buttons
        ...
        new Actions(driver).pause(Duration.ofSeconds(1)).contextClick(onconTextMenu)
               ...
               .pause(Duration.ofSeconds(1)).click(onmousedown) //This click trigger the 'onmouseleave' element
               .pause(Duration.ofSeconds(1)).click(onmousedown) //This click trigger the 'onmousedown' element
               .perform();
